...
if (typeof window !== 'undefined' && window.location.hostname !== 'localhost' && window.location.hostname !== '127.0.0.1' && API_BASE.includes('localhost')) {
  console.warn(
    '⚠️ [Shoolin OS]: Hosted webapp is configured with NEXT_PUBLIC_API_URL pointing to localhost. Set NEXT_PUBLIC_API_URL in Netlify Environment Variables to your live backend server URL (e.g., https://your-backend.onrender.com/api).'
  );
}
